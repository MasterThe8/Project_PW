...
(2, 'Sample Book 102', 2018, 2, 450, 'book2.jpg', 'Publisher 2', 'Author 2 et. al.', 5),
(3, 'Sample Book 103', 2020, 3, 750, 'book3.jpg', 'Publisher 3', 'Author 3 et. al.', 8);
...
(2, 6, 'Wayan', 750, '2023-05-28', 'Sample Book 103', 1),
(3, 6, 'Lalu Awaludin', 450, '2023-05-28', 'Sample Book 102', 1),
(4, 8, 'Gishimori', 900, '2023-05-29', 'Sample Book 102', 2),
(5, 8, 'laliberte', 1200, '2023-05-29', 'Sample Book 102', 1);
...
(6, 'Sekaiwa yume kara', 'Sekai', '9cdfb439c7876e703e307864c9167a15', 'cashier'),
(7, 'LizNoir', 'lz', '9cdfb439c7876e703e307864c9167a15', 'staff'),
(8, 'Ghifary Ahada Azra', 'gufar', '9cdfb439c7876e703e307864c9167a15', 'admin');
...
--
ALTER TABLE `book_category`
  MODIFY `category_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `transaction`
--
ALTER TABLE `transaction`
  MODIFY `transaction_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
